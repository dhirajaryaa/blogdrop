...
} from-primary/15 via-transparent to-transparent pointer-events-none" />
      <div className="absolute inset-0 .bg-\[radial-gradient\(ellipse_at_bottom\,_var\(--tw-gradient-stops\)\)\] {
